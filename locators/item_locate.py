class ItemLinks:
    item1_namelink = ('xpath', '//a[@id = "item_4_title_link"]')
    item2_namelink = ('xpath', '//a[@id = "item_0_title_link"]')
    item3_namelink = ('xpath', '//a[@id = "item_1_title_link"]')
    item4_namelink = ('xpath', '//a[@id = "item_5_title_link"]')
    item5_namelink = ('xpath', '//a[@id = "item_2_title_link"]')
    item6_namelink = ('xpath', '//a[@id = "item_3_title_link"]')
    item1_imglink = ('xpath', '//a[@id = "item_4_img_link"]')
    item2_imglink = ('xpath', '//a[@id = "item_0_img_link"]')
    item3_imglink = ('xpath', '//a[@id = "item_1_img_link"]')
    item4_imglink = ('xpath', '//a[@id = "item_5_img_link"]')
    item5_imglink = ('xpath', '//a[@id = "item_2_img_link"]')
    item6_imglink = ('xpath', '//a[@id = "item_3_img_link"]')


class ItemLocate:
    item_name = ('xpath', '//div[@class = "inventory_details_name"]')
    item_descr = ('xpath', '//div[@class = "inventory_details_desc"]')
    item_price = ('xpath', '//div[@class = "inventory_details_price"]')
    item_img = ('xpath', '//img[@class = "inventory_details_img"]')
    go_back = ('xpath', '(//button[@class="inventory_details_back_button')
    add_button_item = ('xpath', '//button[@class="btn_primary btn_inventory"]')
    remove_button_item = ('xpath', '//button[@class="btn_secondary btn_inventory"]')


class ItemData:
    item1_name = 'Sauce Labs Backpack'
    item1_desc = ('carry.allTheThings() with the sleek, streamlined Sly Pack that melds '
    ...
    item2_desc = ("A red light isn't the desired state in testing but it sure helps when riding your "
    ...
    item5_desc = ("Rib snap infant onesie for the junior automation engineer in development. Reinforced "
    ...
    item6_desc = ('This classic Sauce Labs t-shirt is perfect to wear when cozying up to your keyboard to '
